...
public interface Constants {
    ...
    String DISCOUNT_NO_USE_COUNT = DISCOUNT_50_COUNT + "=" + "0" + "|" + DISCOUNT_200_COUNT + "=" +"0" + "|" + DISCOUNT_500_COUNT +
            "=" + "0" + "|" + DISCOUNT_MORE_COUNT + "=" +"0" + "|" + DISCOUNT_DIRECT_COUNT + "=" +"0";


    String DISCOUNT_AVERATE = "averageDiscount";
